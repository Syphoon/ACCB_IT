		...
		realm.write(() => {
			realm.create(
				'Coletas',
				{
					...
					coleta_preco_cesta:
						research.coleta_preco_cesta == null
							? parseFloat(0)
							: parseFloat(research.coleta_preco_cesta),
					...
					estabelecimento_secundario:
						research.estabelecimento_secundario[0] != undefined
							? JSON.stringify(research.estabelecimento_secundario)
							: 'Não tem estabelecimento secundário',
					pesquisa_id: parseInt(research.pesquisa_id),
					bairro_nome: research.bairro_nome,
					coleta_data: research.coleta_data,
					coleta_fechada:
						research.coleta_fechada == null
							? 0
							: parseInt(research.coleta_fechada),
					enviar: false,
				},
				'modified',
			);
						...
						try {
							json.coletas.map(coleta => {
								...
								let check_coleta = coletas.filtered(
									`id = ${coleta.coleta_id} && pesquisa_id = ${coleta.pesquisa_id} && coleta_fechada = 1`,
								);
